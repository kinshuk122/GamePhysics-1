...
static void ProjectPoints(const std::vector<glm::vec2>& polygonPoints,
                          glm::vec2 normal,
                          float& min,
                          float& max) {
    min = FLT_MAX;
...
static void ProjectCircle(const glm::vec2& circlePosition,
                          float circleRadius,
                          glm::vec2 normal,
                          float& min,
                          float& max) {
...
static glm::vec2 ClosestPointOnPolygon(
...
float PhysicsUtils::GetMomentOfInertiaRegularPolygon(int pointCount,
                                                     float radius,
                                                     float mass) {
    float sin = sinf(Math::PI / pointCount);
...
static void FindClosestPointOnLine(glm::vec2 p,
                                   glm::vec2 a,
                                   glm::vec2 b,
